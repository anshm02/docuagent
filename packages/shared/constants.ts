...
export const MAX_FREE_TIER_FEATURES = 5;
export const MAX_PRESCAN_CANDIDATES = 12; // Don't pre-scan more than 12 pages
export const FEATURE_TIMEOUT_MS = 90_000; // 90 second hard timeout per feature crawl
